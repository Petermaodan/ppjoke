...
//    }
    ...
    public static LiveDataBus get(){return Lazy.sLiveDataBus;}
    ...
    public static class StickyLiveData<T> extends LiveData<T> {
        ...
        //将传递进去的observer进行一个封装。同样需要在WrapperObserver中定义一个LastVersion。当生命周期发生变化时，会对调到onStartChanged()方法中，将数据发送到头部列表，并修改其ui
        @Override
